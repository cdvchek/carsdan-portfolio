...
function Project(props) {
    ...
    const {title, description, thoughts, image, setView, github, site, } = props;
            ...
            <div id="content">
                ...
                <div id="project-buttons">
                    <button className="ext-btn" id="github-btn" onClick={() => window.location = github}>
                        ...
                        <span className='project-btn-word'>
                            Github
                        </span>
                    </button>
                    <button className="ext-btn" id="site-btn" onClick={() => window.location = site}>
                        <span className='project-icon'>
