...
function Work() {
  ...
  return (
    <div className="Work">
      <div id='card-holder'>
        <div className='big-card' id='big-card-northlake-timecards' onClick={() => changeView("/projects/nlcctimecard")}>
        ...
        <div className='big-card' id='big-card-uw-bootcamp-projects' onClick={() => changeView('/projects/uwcbprojects')}>
