...
function Work() {
  ...
  if (view === 'overview') {
    return (
      <div className="Work">
        <div id='card-holder'>
          <div className='big-card' id='big-card-northlake-timecards' onClick={() => changeToWork('northlake-timecards')}>
          ...
          <div className='big-card' id='big-card-uw-bootcamp-projects' onClick={() => changeToWork('uw-bootcamp-projects')}>
  ...
  } else if (view === 'northlake-timecards') {
    return (
      <Project 
        setView={setView} 
        title={p1Title} 
  ...
  } else if (view === 'uw-bootcamp-projects') {
    return (
      <Project
        setView={setView}
        title={p2Title}
