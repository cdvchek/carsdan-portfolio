      ...
      <div id='Work' className="Working">
        <div className='work-content'>
          ...
          <div className='card-wrapper'>
            <div className='card-outline' id='card-outline-northlake-timecards'>
              <div className='normal-card' id='normal-card-northlake-timecards'>
            ...
            <div className='card-outline' id='card-outline-uw-bootcamp-projects'>
              <div className='normal-card' id='normal-card-uw-bootcamp-projects'>
